...
public class DataHelper {
    ...
    public static int BalanceOfCardFromTransfer(int balance, int amountForTransfer) {
        int finalBalance = balance - amountForTransfer;
        return finalBalance;

    }

    public static int BalanceOfCardToTransfer(int balance, int amountForTransfer) {
        int finalBalance = balance + amountForTransfer;
        return finalBalance;
    }

    public static String amountToAddForTest() {
        return ("1000");
    }
}